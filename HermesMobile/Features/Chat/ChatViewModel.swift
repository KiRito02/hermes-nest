...
final class ListenRemoteControlController: ListenRemoteControlControlling {
    ...
    func update(_ snapshot: ListenNowPlayingSnapshot) {
        MPNowPlayingInfoCenter.default().nowPlayingInfo = [
            ...
            MPMediaItemPropertyArtist: "Hermes Nest",
...
final class ChatViewModel {
    ...
    private var listenPlaybackTitle = String(localized: "Hermes Nest response")
    ...
    func toggleListening(to context: MessageActionContext) {
        ...
        // fetch would silence other audio while Hermes Nest has nothing to play (review
    ...
    private func beginListenPlaybackPreparation(for context: MessageActionContext) {
        listenPlaybackTitle = String(localized: "Hermes Nest response \(context.visibleIndex + 1)")
    ...
    private func speakWithOnDeviceSynthesizer(_ text: String) {
        ...
        // never interrupts other audio while Hermes Nest is silent (review on #35).
