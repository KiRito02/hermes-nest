                    ...
                    if let settingsURL = URL(string: UIApplication.openSettingsURLString) {
                        Link(destination: settingsURL) {
                            SettingsAccessoryRow(
                                title: String(localized: "Open Hermes Nest Settings"),
                                systemImage: "gearshape",
                                accessorySystemImage: "arrow.up.forward"
                            )
                        }
                        .buttonStyle(.plain)
                        .accessibilityLabel("Open Hermes Nest Settings")
                    }

                    SettingsFootnote(String(localized: "Run Hermes Nest actions like New Chat from Siri, Spotlight, the Lock Screen, or the iPhone Action button. Open Hermes Nest Settings to manage its Siri & Search options. To assign an action to the Action button, open the iOS Settings app, choose Action Button, then Shortcut, and pick a Hermes Nest action."))
                }
