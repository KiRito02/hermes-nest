...
/// "New Chat" — opens Hermes Nest on the New Chat composer, mirroring the in-app "+" button
...
struct NewChatIntent: AppIntent {
    ...
    static var description = IntentDescription("Open Hermes Nest on a new, empty chat.")
...
/// "New Chat with Voice" — opens Hermes Nest on the New Chat composer and auto-starts voice
...
struct NewChatVoiceIntent: AppIntent {
    ...
    static var description = IntentDescription("Open Hermes Nest on a new chat and start voice dictation.")
...
/// "New Chat in <Profile>" — opens Hermes Nest on a new chat pinned to a specific server profile
...
/// query item for the preserved profile-aware routing contract.
struct NewChatInProfileIntent: AppIntent {
    static var title: LocalizedStringResource = "New Chat in Profile"
    static var description = IntentDescription("Open Hermes Nest on a new chat pinned to a specific profile.")
...
/// Registers Hermes Nest's App Shortcuts. iOS discovers this conformance automatically at build
