# Legacy TestFlight Runbook — Retired
...
The related GitHub Actions upload workflows were removed during the earlier
Gateway contract transition. Do not recreate or execute an App Store upload
unless the owner explicitly changes the distribution decision in a new Issue.
...
The previous upstream runbook remains available in Git history.
