...
Canonical language for Hermes Nest concepts that need consistent names across the product, planning, and support.

## Kanban

**Kanban**:
The Hermes Nest destination for organizing and operating server-backed work across workflow states.
...
**Archive Board**:
The action that removes a non-default Board from active use. Hermes Nest cannot restore an archived Board in-app.
