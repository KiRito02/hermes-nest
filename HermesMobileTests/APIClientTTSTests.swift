...
final class APIClientTTSTests: APIClientTestCase {
    func testSynthesizeSpeechPostsJSONAndReturnsRawAudioBytes() async throws {
        ...
        let client = makeClient { request in
            ...
            XCTAssertEqual(json["text"] as? String, "Hello from Hermes Nest.")
        ...
        let data = try await client.synthesizeSpeech(text: "Hello from Hermes Nest.", voice: "en-US-AriaNeural")
